...
const pilotVatReview: VatReviewResult = {
  ...
  assuranceChecks: [
    ...
    { id: "VAT-A05", suite: "vat_assurance_v2", category: "trend_analysis", title: "Prior-period comparison", status: "passed", severity: "low", detail: "Net VAT due moved +13.4% (£13,400 → £15,200), within the 30% review threshold — consistent with higher standard-rated sales." },
  ],
  workpaper: {
    reference: "WP-02 VAT",
    objective: "Confirm the May 2026 VAT return is arithmetically correct, reconciled, supported by transaction evidence and consistent with the prior period.",
    risk: "Incorrect VAT coding, an unreconciled control balance or an unexplained movement could misstate the liability.",
    evidenceReviewed: ["vat-detail-may.csv", "vat-control-reconciliation.xlsx", "trial-balance-may.csv", "vat-return-april-2026.csv"],
    proceduresPerformed: ["Recalculated Boxes 1–9", "Agreed Box 5 to the VAT control account", "Reviewed reverse-charge and PIVA treatments", "Inspected the late purchase VAT journal", "Compared net VAT due to the prior period"],
    findings: ["The initial GBP 12,300 control difference was cleared by an evidenced late journal.", "Net VAT due rose 13.4% on the prior period (£13,400 → £15,200), within the 30% review threshold and consistent with higher standard-rated sales.", "No filing blocker remains."],
    conclusion: "The adjusted VAT return is ready for reviewer acknowledgement. Prior-period movement has been reviewed and is within threshold.",
  },
  periodComparison: { currentVatDue: 15200, previousVatDue: 13400, movement: 1800, percentageChange: 13.4, threshold: 30, status: "stable", primaryDriver: "Higher standard-rated sales in the period", detail: "Net VAT due rose 13.4% (£13,400 → £15,200), within the 30% review threshold — consistent with the increase in standard-rated turnover." },
  exceptionDashboard: { high: 0, medium: 0, low: 0, total: 0, categories: { boxValidation: 0, controlReconciliation: 0, manualJournals: 0, reverseCharge: 0, piva: 0, trendAnalysis: 0, codingAndRates: 0, schemeCompliance: 0, evidenceQuality: 0 } },
  filingSignOff: { status: "ready_to_submit", label: "Ready to Submit", blockers: [], risks: [], detail: "Core return, control reconciliation and prior-period movement checks all passed." },

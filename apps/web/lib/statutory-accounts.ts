...
import { buildManagementAccounts, ledgerPhrase, type SyncStatements } from "./management-accounts";
...
`;
  ...
  <div class="cover">
    ...
    <div class="period" style="font-size:12px">Draft prepared by ClosePilot from ${meta.sourceLabel} — subject to review and approval</div>
  </div>
  ...
  <footer>
    Draft generated by ClosePilot from ${meta.sourceLabel} for accounts-production purposes. Statutory disclosures, tax and directors' report remain the responsibility of the preparer and must be reviewed before filing. Figures are presented to the nearest £; brackets denote negatives/liabilities.
  </footer>`;

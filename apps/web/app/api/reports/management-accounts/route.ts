...
import { buildManagementAccounts, renderManagementAccountsHtml, type SyncStatements } from "@/lib/management-accounts";
...
export async function GET(request: Request) {
  ...
  const html = renderManagementAccountsHtml(pack, { autoPrint });
